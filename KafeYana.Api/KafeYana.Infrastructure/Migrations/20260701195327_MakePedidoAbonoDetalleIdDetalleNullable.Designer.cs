...
namespace KafeYana.Infrastructure.Migrations
{
    ...
    [Migration("20260701195327_MakePedidoAbonoDetalleIdDetalleNullable")]
    partial class MakePedidoAbonoDetalleIdDetalleNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KafeYana.Domain.Entities.PedidoAbono", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("PedidoAbono", (string)null);
                });

            modelBuilder.Entity("KafeYana.Domain.Entities.PedidoAbonoDetalle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("PedidoAbonoDetalle", (string)null);
                });
            ...
            modelBuilder.Entity("KafeYana.Domain.Entities.PedidoAbono", b =>
                {
                    b.HasOne("KafeYana.Domain.Entities.Pedido", "Pedido")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_pedidoabono_pedido");
            ...
            modelBuilder.Entity("KafeYana.Domain.Entities.PedidoAbonoDetalle", b =>
                {
                    b.HasOne("KafeYana.Domain.Entities.PedidoAbono", "Abono")
                        .WithMany("Detalles")
                        .HasForeignKey("Id_Abono")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_pedidoabonodetalle_abono");

                    b.HasOne("KafeYana.Domain.Entities.Inventario.Detalle_ronda", "Detalle")
                        .WithMany()
                        .HasForeignKey("Id_Detalle")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_pedidoabonodetalle_detalle");
