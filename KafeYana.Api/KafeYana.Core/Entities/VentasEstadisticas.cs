namespace KafeYana.Domain.Entities
{
    ...
    ///
    /// Todos los campos EXCLUYEN las ventas anuladas; incluyen las no facturadas,
    /// observadas y pendientes.
    /// </summary>
    public class VentasEstadisticas
    {
        /// <summary>Suma de <c>MontoTotal</c> de ventas del día actual (excluye anuladas).</summary>
        public decimal TotalHoy { get; set; }

        /// <summary>Suma de <c>MontoTotal</c> de ventas del mes actual (excluye anuladas).</summary>
        public decimal TotalMes { get; set; }

        /// <summary>Cantidad de ventas del día actual (excluye anuladas).</summary>
        public int ConteoHoy { get; set; }

        /// <summary>Cantidad de ventas del mes actual (excluye anuladas).</summary>
