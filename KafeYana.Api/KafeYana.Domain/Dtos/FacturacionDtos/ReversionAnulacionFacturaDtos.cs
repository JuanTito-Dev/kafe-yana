...
{
    public class SolicitudReversionAnulacionFacturaDto
    {
    ...
    public class RespuestaReversionAnulacionFacturaDto
    {
    ...
    public sealed class ResultadoReversionAnulacionFacturaDto
    {
